...
Use the [GitHub Security Advisory](https://github.com/ktestify/ktestify-plugin-archetype/security/advisories/new)
...
This policy applies to the `ktestify-plugin-archetype` library and its direct dependencies.
